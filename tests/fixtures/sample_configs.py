...
def minimal_config() -> SimulationConfig:
    ...
    return SimulationConfig(
        workspace=WorkspaceConfig(bounds=[[0.0, 10.0], [0.0, 10.0]], obstacles=[]),
        deceptive_agent=DeceptiveAgentConfig(
            ...
            observer=ObserverConfig(checkpoint_path="models/observer.eqx", num_goals=3),
        ),
...
def config_with_obstacles() -> SimulationConfig:
    ...
    return SimulationConfig(
        workspace=WorkspaceConfig(
            ...
            obstacles=[
                ObstacleConfig(
                    type="circle", params={"center": [5.0, 5.0], "radius": 1.5}
                ),
                ObstacleConfig(
                    type="polygon",
...
def config_agent_d_wins() -> SimulationConfig:
    ...
    return SimulationConfig(
        ...
        simulation=SimulationParameters(max_time=5.0, intercept_threshold=0.3),
    )
